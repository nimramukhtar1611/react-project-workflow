...
useEffect(() => {
  ...
  return (
    <section
      className="py-5"
      style={{ background: "#f6f7fa", fontFamily: "'Poppins', Arial, sans-serif" }}
    >
      <div className="container">
        <div className="row align-items-stretch justify-content-center">
          {/* Image Box */}
<div className="col-12 col-md-5 d-flex justify-content-center justify-content-md-end mb-4 mb-md-0" >
<div
  style={{
    height: "95%",
    width: "100%",
...
>
          ...
          {/* Text Content */}
          <div className="col-12 col-md-7 mt-2 d-flex flex-column justify-content-center">
            <div
              style={{
                maxWidth: "520px",
                margin: "0 auto",
            ...
            >
              ...
              <div style={{ fontWeight: 600, fontSize: "1.05rem", color: "#222", marginBottom: "2px" }}>
                Sibyl Vane
              </div>

              <div style={{ color: "#b89f5a", fontWeight: 500, fontSize: "0.95rem", marginBottom: "15px" }}>
                Executive Chef
              </div>

              <div style={{ fontSize: "1rem", fontWeight: 400, color: "#222", marginBottom: "15px", lineHeight: 1.6 }}>
              ...
              <div style={{ fontSize: "1rem", fontWeight: 400, color: "#222", marginBottom: "22px", lineHeight: 1.6 }}>
              ...
              <div className="d-flex flex-wrap gap-2 mb-4">
                {["Michelin Star 2020", "James Beard Award", "Food Best Chef"].map((award, index) => (
                  <span
                    key={index}
                    style={{
                      background: "#f4f1e8",
